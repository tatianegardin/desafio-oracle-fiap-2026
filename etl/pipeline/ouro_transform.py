...
COMENTARIOS = [
    ...
    "COMMENT ON TABLE gld_perfil_clinico IS 'Perfil epidemiologico das internacoes: quantas internacoes, permanencia e mortalidade por hospital, competencia, faixa etaria e capitulo da CID-10. Grao: hospital x mes x faixa etaria x capitulo'",
        "COMMENT ON COLUMN gld_diagnosticos.faixa_etaria IS 'Faixa etaria do paciente: Menor de 1 ano, Crianca (1 a 11), Adolescente (12 a 17), Adulto (18 a 59), Idoso (60 ou mais) ou Idade nao informada. A faixa Idade nao informada reune 474 internacoes sem idade registrada, com mortalidade atipica de 39,87 por cento'",
    ...
    "COMMENT ON COLUMN gld_perfil_clinico.competencia IS 'Mes de referencia no formato AAAAMM'",
    "COMMENT ON COLUMN gld_perfil_clinico.co_cnes IS 'Codigo CNES do estabelecimento'",
    "COMMENT ON COLUMN gld_perfil_clinico.nome_estabelecimento IS 'Nome do hospital. Use esta coluna para exibir o hospital, nao o codigo'",
    "COMMENT ON COLUMN gld_perfil_clinico.tipo_unidade IS 'Tipo do estabelecimento: HOSPITAL GERAL, HOSPITAL ESPECIALIZADO, PRONTO SOCORRO'",
    "COMMENT ON COLUMN gld_perfil_clinico.nr_capitulo IS 'Numero do capitulo da CID-10'",
    "COMMENT ON COLUMN gld_perfil_clinico.perm_media IS 'Permanencia media em dias'",
    "COMMENT ON COLUMN gld_perfil_clinico.obitos IS 'Quantidade de obitos no periodo'",
    "COMMENT ON COLUMN gld_perfil_clinico.tx_mortalidade IS 'Percentual de obitos sobre as internacoes'",
    "COMMENT ON COLUMN gld_perfil_clinico.idade_media IS 'Idade media em anos dos pacientes internados'",
    "COMMENT ON COLUMN gld_regional.competencia IS 'Mes de referencia no formato AAAAMM'",
    "COMMENT ON COLUMN gld_regional.paciente_dia IS 'Soma dos dias de permanencia na zona, numerador da taxa de ocupacao'",
    "COMMENT ON COLUMN gld_regional.leito_dia IS 'Leitos SUS multiplicados pelos dias do mes, denominador da taxa de ocupacao'",
    "COMMENT ON COLUMN gld_regional.criticos IS 'Hospitais da zona com ocupacao acima de 85 por cento'",
    "COMMENT ON COLUMN gld_regional.atencao IS 'Hospitais da zona com ocupacao entre 70 e 85 por cento'",
    "COMMENT ON COLUMN gld_sazonalidade.competencia IS 'Mes de referencia no formato AAAAMM'",
    "COMMENT ON COLUMN gld_sazonalidade.competencia_label IS 'Mes por extenso, para exibicao'",
    "COMMENT ON COLUMN gld_sazonalidade.nr_ano IS 'Ano da competencia'",
